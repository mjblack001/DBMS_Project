...
$que =  " SELECT * FROM student, login WHERE student.username = login.username AND student.username ='$username'";
...
?>
	...
	<div class="container">
		<form name="form1" action="changeProfilePass.php" method="post" onsubmit="return(validation());">
		<div class="col-md-6 sidebar">
