		...
		<div class="row">
            ...
            <div class="col-md-6 col-xs-12 header-top-right">
                <div>
                    ...
                    <div class="languages">
                        <ul>
                            <li> <a href="login.php"><i class="icon-user"></i><img src="assets/img/icons/login_icon.png" <!--height="22" width="22"--></a></li> 
			...
			<div class="row">
				<div class="col-md-12 clearfix">
					...
					<nav class="collapse navbar-collapse navbar-collapse" role="navigation">
						...
						<li><a href="findTutor.php"><i class="icon icon-normal-profile-checkbox"></i> Find Tutor</a></li>
